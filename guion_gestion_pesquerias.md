# Gestión de pesquerías
  ...
  ![portada](https://raw.githubusercontent.com/aprendiendo-cosas/Te_gestion_pesquerias_gesteco_ccaa/main/imagenes/portada.jpg)
...
Este guión forma parte del bloque denominado "Técnicas o métodos usados actualmente en la gestión de ecosistemas", de la asignatura de Gestión de ecosistemas. En concreto, este guión trata los procedimientos que hemos creado para manejar los recursos pesqueros en el océano.

El objetivo de aprendizaje general es aquirir una serie de ideas básicas para entender cómo se han diseñado y cómo se ponen en práctica los mecanismos de gestión de recursos pesqueros. De manera más específica, los objetivos son:
+ Aprender cómo se conectan las teorías ecológicas ya conocidas con técnicas de manejo de recursos pesqueros.
+ Entender la evolución histórica de este ámbito temático desde la preocupación única por las especies a una visión más rica y ecosistémica.
+ Empezar a conectar con la importancia de las escalas de gobernanza en la gestión de ecosistemas.
+ Inferir paralelismos entre ámbitos de gestión diferentes. Por ejemplo, relaciones entre gestión pesquera y cinegética.
+ Conocer cómo se aplican las técnicas anteriormente estudiadas a un caso de estudio local: la pesca del atún en la costa de Cádiz.
...
La gestión de pesquerías se define como el conjunto de procesos dirigidos a regular la extracción de recursos biológicos marinos, enfrentándose al reto continuo de armonizar un sistema multiobjetivo que en la práctica puede generar conflictos (trade-offs). Esta gestión ecosistémica persigue el equilibrio de tres grandes pilares:

1. **Objetivos biológicos o de conservación:** orientados a mantener la viabilidad de las poblaciones a largo plazo y asegurar la sostenibilidad biológica, siendo su concepto rector el Rendimiento Máximo Sostenible (RMS).
2. **Objetivos económicos (eficiencia):** que buscan maximizar el beneficio neto de la actividad extractiva para que esta resulte rentable y promueva el desarrollo económico de las comunidades costeras.
3. **Objetivos sociales (equidad y empleo):** que aseguran que la actividad pesquera sostiene el tejido social de los actores dependientes, fomentando el empleo y evitando situaciones de exclusión.

#### 2.3 Fundamentos científicos que sustentan en la actualidad las herramientas de gestión
...
- **Controles de salida:** Regulan la cantidad de biomasa extraída mediante Capturas Totales Permitidas (TAC, por sus siglas en inglés) y el establecimiento de cuotas individuales, que aseguran la rentabilidad económica al repartir el recurso entre embarcaciones o empresas. Teóricamente, esto equivale a la "extracción de cuota fija", que aunque otorga estabilidad en el retorno, conlleva el riesgo de extinción si la capacidad de carga del ambiente fluctúa negativamente.
...
1. **Era de la inagotabilidad (antes de 1900):** La vasta extensión oceánica generó la falsa creencia de que los recursos pesqueros eran inextinguibles, careciendo de censos o límites.
2. **Nacimiento de la ciencia pesquera (1900-1945):** La mecanización de la flota (barcos a vapor) incrementó la capacidad de captura, evidenciando declives poblacionales. Se inician las primeras medidas básicas, como vedas y tallas mínimas.
3. **Edad de oro de los modelos monoespecíficos (1945-1980):** Con el desarrollo del radar y sonar y los avances en la dinámica de poblaciones, se adopta el cálculo del RMS y nacen las grandes organizaciones regionales para la gestión de cupos.
...
5. **Enfoque ecosistémico y climático (2000-actualidad):** Se consolida la modelización bioinformática considerando que la capacidad de carga ($K$) no es constante y que está fuertemente alterada por las variaciones climáticas y las interacciones tróficas ("transformación azul").
...
- **Escala Global:** Instrumentada por la ONU mediante tratados internacionales sobre alta mar y la protección de la biodiversidad.
- **Escala Europea:** Regida por la Política Pesquera Común (PPC). El Reglamento 1380/2013 es capital al fijar el Rendimiento Máximo Sostenible como estándar obligatorio e instaurar la obligación de desembarque (para evitar el descarte de ejemplares al mar). Los reglamentos periódicos (ej. Reglamento 2026/249) establecen los límites anuales de las posibilidades de pesca.
...
- **Gestión multiobjetivo y de efectos en cadena:** La recuperación de un depredador apical protegido (como el atún) desencadena una mayor presión sobre sus presas directas (sardinas, boquerones), comprometiendo simultáneamente las capturas y rentabilidad de otras flotas pesqueras.
- **Etología y nuevas interacciones inter-específicas:** La adaptación conductual de algunas especies (ej. orcas que aprenden a extraer atunes directamente de las redes de las almadrabas) obliga a repensar las intervenciones espaciales y técnicas desde la etología animal.
- **Sostenibilidad del hábitat y resiliencia climática:** Se debe lidiar con la perturbación exógena producida por el cambio climático, la contaminación por microplásticos y las sustancias bioacumulables, que amenazan tanto la seguridad alimentaria como el funcionamiento estructural de las cadenas tróficas.
- **Equidad socioeconómica:** Supone un reto constante compatibilizar la pesca industrial a gran escala con los derechos de la pesca artesanal de pequeña escala, que resulta fundamental como fuente de proteína, arraigo cultural y soberanía alimentaria para las comunidades litorales de proximidad.
...
## 2 Definición y objetivos de la gestión de pesquerías



## 3 Fundamentos científicos que sustentan la gestión de recursos pesqueros 


## 4 Métodos y técnicas usadas actualmente


## 5 Breve historia de la gestión de pesquerías



## Marco legal en Europa, España y Andalucía




## Ejemplos relevantes de gestión de pesquerías en nuestro entorno


## Retos de la gestión de pesquerías
